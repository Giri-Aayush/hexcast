...
// Build-time flag: the Google button only renders when the OAuth app is actually
// configured, so we never ship a button that 500s because the server has no client
// secret. Set NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=1 alongside the server-side
