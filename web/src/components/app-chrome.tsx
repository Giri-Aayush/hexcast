 ...
 * itself, but the landing page now lives at `/` — it is not part of the app
 * shell, ships its own "Install Hexcast" and "Open the feed" CTAs, and the dark
 * bottom-nav pill has no meaning on a page with no tabs to switch between.
 *
